...
#G++ build
sudo apt-get install libc-dev-bin libc6 libc6:i386 libc6-dev libcurl3 libglademm-2.4-1c2a libgtkmm-2.4-1c2a cmake g++-4.7 build-essential glibc-doc glibc-doc valgrind locales -y
